...
public class BisectionMethod {
    ...
    /**
     * The main method is the entry point of the program and executes the main logic of the program,
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (option > 0 && option < 4) {
                System.out.print("Floor of the interval: ");
                a = Double.valueOf(in.nextLine());
                System.out.print("Ceiling of the interval: ");
    ...
    public static int menu() {
        ...
        try {
            var selection = Integer.valueOf(in.nextLine());
        } catch (Exception e) {
